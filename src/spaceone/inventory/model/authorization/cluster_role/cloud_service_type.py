...
cst_cluster_role.tags = {
    "spaceone:icon": "https://spaceone-custom-assets.s3.ap-northeast-2.amazonaws.com/console-assets/icons/cloud-services/kubernetes/cluster_role.svg",
}
...
CLOUD_SERVICE_TYPES = [
    CloudServiceTypeResponse({"resource": cst_cluster_role}),
]
