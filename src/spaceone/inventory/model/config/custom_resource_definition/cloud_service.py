...
metadata = ItemDynamicLayout.set_fields(
    "Metadata",
...
crd_spec_base = ItemDynamicLayout.set_fields(
    "Spec",
    root_path="data.spec",
    fields=[
...
crd_spec_names_base = SimpleTableDynamicLayout.set_fields(
    "Names",
    root_path="data.spec.names",
    fields=[
...
crd_spec = ListDynamicLayout.set_layouts(
    "Spec", layouts=[crd_spec_base, crd_spec_names_base]
)

versions = TableDynamicLayout.set_fields(
    "Versions",
    root_path="data.spec.versions",
    fields=[
        TextDyField.data_source("Name", "name"),
...
conditions = TableDynamicLayout.set_fields(
    "Conditions",
...
additional_printer_columns = TableDynamicLayout.set_fields(
    "Additional Printer Columns",
    root_path="spec.additional_printer_columns",
    fields=[
        TextDyField.data_source("Name", "name"),
        TextDyField.data_source("Type", "type"),
...
class CustomResourceDefinitionResource(ServiceResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=crd_meta, serialized_name="metadata"
    )
