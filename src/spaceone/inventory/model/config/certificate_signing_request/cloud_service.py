...
"""
certificate_signing_request = ItemDynamicLayout.set_fields(
    "CSR",
...
spec = ItemDynamicLayout.set_fields(
    "Spec",
    root_path="data.spec",
    fields=[
        TextDyField.data_source("Uid", "uid"),
...
certificate_signing_request_meta = CloudServiceMeta.set_layouts(
    [certificate_signing_request, spec, annotations, labels]
)
...
class CertificateSigningRequestResource(ServiceResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta,
        default=certificate_signing_request_meta,
