...
cst_pvc = CloudServiceTypeResource()
cst_pvc.name = 'PersistentVolumeClaim'
cst_pvc.provider = 'kubernetes'
cst_pvc.group = 'Storage'
cst_pvc.service_code = 'PersistentVolumeClaim'
cst_pvc.is_primary = True
cst_pvc.is_major = False
cst_pvc.labels = ['Storage']
cst_pvc.tags = {
    'spaceone:icon': 'https://spaceone-custom-assets.s3.ap-northeast-2.amazonaws.com/console-assets/icons/cloud-services/kubernetes/persistent_volume_claim.svg',
}
...
CLOUD_SERVICE_TYPES = [
    CloudServiceTypeResponse({'resource': cst_pvc}),
]