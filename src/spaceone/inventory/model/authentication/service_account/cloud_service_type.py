...
cst_service_account = CloudServiceTypeResource()
cst_service_account.name = 'ServiceAccount'
cst_service_account.provider = 'kubernetes'
cst_service_account.group = 'Authentication'
cst_service_account.service_code = 'ServiceAccount'
cst_service_account.is_primary = True
cst_service_account.is_major = True
cst_service_account.labels = ['Security', 'Management']
cst_service_account.tags = {
    'spaceone:icon': 'https://spaceone-custom-assets.s3.ap-northeast-2.amazonaws.com/console-assets/icons/cloud-services/kubernetes/service_account.svg',
}
...
CLOUD_SERVICE_TYPES = [
    CloudServiceTypeResponse({'resource': cst_service_account}),
]
