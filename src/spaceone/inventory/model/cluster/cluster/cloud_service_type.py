...
cst_cluster.provider = 'kubernetes'
...
cst_cluster._metadata = CloudServiceTypeMeta.set_meta(
    fields=[
        ...
        TextDyField.data_source('CPU Assigned', 'data.cpu_assigned', options={'is_optional': True}),
        TextDyField.data_source('CPU Total', 'data.cpu_total', options={'is_optional': True}),
        TextDyField.data_source('Memory Assigned', 'data.memory_assigned', options={'is_optional': True}),
        TextDyField.data_source('Memory Total', 'data.memory_total', options={'is_optional': True}),
        TextDyField.data_source('Pod Assigned', 'data.pod_assigned', options={'is_optional': True}),
        TextDyField.data_source('Pod Total', 'data.pod_total', options={'is_optional': True})
    ],
