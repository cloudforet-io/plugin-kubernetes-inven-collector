...
stateful_set_pods = TableDynamicLayout.set_fields(
    "Pods",
    root_path="data.pods",
    fields=[
...
stateful_set_meta = CloudServiceMeta.set_layouts(
    [stateful_set_pods, annotations, labels]
)
...
class StatefulSetResource(WorkLoadResource):
    ...
    _metadata = ModelType(
        CloudServiceMeta, default=stateful_set_meta, serialized_name="metadata"
    )
