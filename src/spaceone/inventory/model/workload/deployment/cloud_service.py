...
deployment_metadata_base_meta = ItemDynamicLayout.set_fields('Metadata', root_path='data', fields=[
...
deployment_status_conditions_meta = SimpleTableDynamicLayout.set_fields('Conditions', root_path='data.status.conditions', fields=[
...
deployment_metadata_meta = ListDynamicLayout.set_layouts('Metadata', layouts=[
    deployment_metadata_base_meta,
    deployment_status_conditions_meta])

deployment_pods = TableDynamicLayout.set_fields('Pods', root_path='data.pods', fields=[
    TextDyField.data_source('Name', 'metadata.name'),
...
deployment_meta = CloudServiceMeta.set_layouts([deployment_metadata_meta, deployment_pods, annotations, labels])
