...
from spaceone.inventory.model.helm.release.cloud_service import (
    ReleaseResource,
    ReleaseResponse,
)
...
class ReleaseManager(KubernetesManager):
    ...
    def collect_cloud_service(self, params):
        ...
        ##################################
        release_conn: ReleaseConnector = self.locator.get_connector(
        ...
        for release in list_helm_labeled_secret:
            try:
                ...
                collected_cloud_services.append(
                    ReleaseResponse({"resource": release_resource})
                )
    ...
    def _base64_to_dict(helm_data):
        ...
        base64_base64_bytes = (
            helm_data.get("data", {}).get("release", "").encode("ascii")
        )
