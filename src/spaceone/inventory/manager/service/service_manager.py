...
from spaceone.inventory.model.service.service.cloud_service import ServiceResource, ServiceResponse
from spaceone.inventory.model.service.service.cloud_service_type import CLOUD_SERVICE_TYPES
...
class ServiceManager(KubernetesManager):
    ...
    def collect_cloud_service(self, params):
        ...
        ##################################
        service_conn: ServiceConnector = self.locator.get_connector(self.connector_name, **params)
