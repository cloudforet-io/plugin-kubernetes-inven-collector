...
from spaceone.inventory.model.service.ingress.cloud_service import IngressResource, IngressResponse
from spaceone.inventory.model.service.ingress.cloud_service_type import CLOUD_SERVICE_TYPES
...
class IngressManager(KubernetesManager):
    ...
    def collect_cloud_service(self, params):
        ...
        ##################################
        ingress_conn: IngressConnector = self.locator.get_connector(self.connector_name, **params)
        ...
        for ingress in list_all_ingress:
            try:
                ...
                ##################################
                collected_cloud_services.append(IngressResponse({'resource': ingress_resource}))
