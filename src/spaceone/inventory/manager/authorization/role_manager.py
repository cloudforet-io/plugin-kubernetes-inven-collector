...
from spaceone.inventory.model.authorization.role.cloud_service import (
    RoleResource,
    RoleResponse,
)
from spaceone.inventory.model.authorization.role.cloud_service_type import (
    CLOUD_SERVICE_TYPES,
)
...
class RoleManager(KubernetesManager):
    ...
    def collect_cloud_service(self, params):
        ...
        ##################################
        role_conn: RoleConnector = self.locator.get_connector(
        ...
        for role in list_all_role:
            try:
                ...
                collected_cloud_services.append(
                    RoleResponse({"resource": role_resource})
                )
                ...
                error_response = self.generate_resource_error_response(
                    e, "Authorization", "Role", role_name
                )
