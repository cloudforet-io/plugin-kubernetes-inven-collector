...
from spaceone.inventory.model.config.config_map.cloud_service import (
    ConfigMapResource,
    ConfigMapResponse,
)
from spaceone.inventory.model.config.config_map.cloud_service_type import (
    CLOUD_SERVICE_TYPES,
)
...
class ConfigMapManager(KubernetesManager):
    ...
    def collect_cloud_service(self, params):
        ...
        ##################################
        config_map_conn: ConfigMapConnector = self.locator.get_connector(
        ...
        for config_map in list_all_config_map:
            try:
                ...
                collected_cloud_services.append(
                    ConfigMapResponse({"resource": config_map_resource})
                )
                ...
                error_response = self.generate_resource_error_response(
                    e, "Config", "ConfigMap", config_map_name
                )
