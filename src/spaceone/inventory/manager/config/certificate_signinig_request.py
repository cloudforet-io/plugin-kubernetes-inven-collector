...
from spaceone.inventory.model.config.certificate_signing_request.cloud_service import (
    CertificateSigningRequestResource,
    CertificateSigningRequestResponse,
)
from spaceone.inventory.model.config.certificate_signing_request.cloud_service_type import (
    CLOUD_SERVICE_TYPES,
)
from spaceone.inventory.model.config.certificate_signing_request.data import (
...
class CertificateSigningRequestManager(KubernetesManager):
    ...
    def collect_cloud_service(self, params):
        ...
        ##################################
        csr_conn: CertificateSigningRequestConnector = self.locator.get_connector(
        ...
        for csr in list_all_csr:
            try:
                ...
                collected_cloud_services.append(
                    CertificateSigningRequestResponse({"resource": csr_resource})
                )
                ...
                error_response = self.generate_resource_error_response(
                    e, "Config", "CertificateSigningRequest", csr_name
                )
