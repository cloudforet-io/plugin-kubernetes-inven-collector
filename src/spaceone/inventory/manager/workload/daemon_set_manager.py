...
from spaceone.inventory.model.workload.daemonset.cloud_service_type import (
    CLOUD_SERVICE_TYPES,
)
...
class DaemonSetManager(KubernetesManager):
    ...
    def collect_cloud_service(self, params):
        ...
        ##################################
        pod_conn: DaemonSetConnector = self.locator.get_connector(
        ...
        for daemon_set in list_all_daemon_set:
            try:
                ...
                collected_cloud_services.append(
                    DaemonSetResponse({"resource": daemon_set_resource})
                )
